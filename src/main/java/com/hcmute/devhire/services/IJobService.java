...
public interface IJobService {
    ...
    Page<JobDTO> getAllJobsAdmin(PageRequest pageRequest, String username) throws Exception;
    ...
    Page<JobDTO> getJobsByCompany(PageRequest pageRequest, String username) throws Exception;
